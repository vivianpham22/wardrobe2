...
namespace wardrobe2.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopType,TopColor,TopSeason,TopOccasion,TopPhoto")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopType,TopColor,TopSeason,TopOccasion,TopPhoto")] Top top)
        {
            if (ModelState.IsValid)
            {
