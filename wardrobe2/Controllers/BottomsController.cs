...
namespace wardrobe2.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,BottomType,BottomColor,BottomSeason,BottomOccasion,BottomPhoto")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,BottomType,BottomColor,BottomSeason,BottomOccasion,BottomPhoto")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
